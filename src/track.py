...
class TrackWidget(BoxLayout):
    def __init__(self, sound, audio_engine, nb_steps, track_source, steps_left_align, **kwargs):
        ...
        separator_image = Image(source="../res/images/track_separator.png")
        ...
        for i in range(0, nb_steps):
            ...
            if int(i/4) % 2 == 0:
                step_button.background_normal = "../res/images/step_normal1.png"
            else:
                step_button.background_normal = "../res/images/step_normal2.png"
